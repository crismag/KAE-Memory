...
REGISTRY: tuple[Capability, ...] = (
    ...
    Capability(
        ...
        http=(
            ...
            "GET /v1/projects/{project_id}/sources/{source_id}/documents",
    ...
    Capability(
        key="synthesis.rules.run",
        summary="Turn rule evidence into a model that says what each rule weighs",
        exposure=Exposure.PRODUCT_ONLY,
        http=("POST /v1/projects/{project_id}/model/rules/runs",),
        reason=_SYNTHESIS_HTTP_ONLY,
    ),
    Capability(
        key="synthesis.rules.attribution.add",
        summary="Record where one rule came from, which is what gives it authority",
        exposure=Exposure.PRODUCT_ONLY,
        http=("POST /v1/projects/{project_id}/model/rules/{object_id}/attribution",),
        reason=_SYNTHESIS_HTTP_ONLY,
    ),
    Capability(
        key="synthesis.rules.attribution.read",
        summary="Read where the project's rules were said to come from",
        exposure=Exposure.PRODUCT_ONLY,
        http=("GET /v1/projects/{project_id}/model/rules/attributions",),
        reason=_SYNTHESIS_HTTP_ONLY,
    ),
    Capability(
        key="synthesis.rules.mechanisms.add",
        summary="Name what enforces one rule, which is what makes it a control",
        exposure=Exposure.PRODUCT_ONLY,
        http=("POST /v1/projects/{project_id}/model/rules/{object_id}/mechanisms",),
        reason=_SYNTHESIS_HTTP_ONLY,
    ),
    Capability(
        key="synthesis.rules.mechanisms.read",
        summary="Read the mechanisms the project's rules are enforced by",
        exposure=Exposure.PRODUCT_ONLY,
        http=("GET /v1/projects/{project_id}/model/rules/mechanisms",),
        reason=_SYNTHESIS_HTTP_ONLY,
    ),
    Capability(
    ...
    Capability(
        key="synthesis.assumptions.run",
        summary="Turn assumption evidence into project beliefs and what each costs if wrong",
        exposure=Exposure.PRODUCT_ONLY,
        http=("POST /v1/projects/{project_id}/model/assumptions/runs",),
        reason=_SYNTHESIS_HTTP_ONLY,
    ),
    Capability(
