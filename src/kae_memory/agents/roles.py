...
The third authorised role, review, has no class here. It is a step on the
worker (:mod:`kae_memory.worker.execution`) so that a review keeps the lease,
checkpoint, and recovery the other roles get from being claimed rather than
called. Its engine is :class:`~kae_memory.agents.review.ReviewPort`.
"""
